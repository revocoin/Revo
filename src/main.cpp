...
const string strMessageMagic = "RevoCoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    nRewardCoinYear = MAX_MINT_PROOF_OF_STAKE;
     ...
     if(pindexBest->nHeight > (2 * 525600))
     {
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RevoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "18/07/2014";
        CTransaction txNew;
        txNew.nTime = 1405641662;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1405641662;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1271698;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x3b1d336355661ec5228b6645cdf143f5ea8aa77d2bdc0c876c4be5a9aca815c2"));
        block.print();
